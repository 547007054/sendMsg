	...
	m.events = {
		...
		theme: function() {
			...
			m.popupRight({
				id: "layer-theme",
				type: 2,
				content: n ? n : "/static/tpl/tpl-theme.html"
			})
		},
		note: function() {
			var n = h(this).attr("data-url");
			m.popupRight({
				...
				type: 2,
				closeBtn: false,
				content: n ? n : "/static/tpl/tpl-note.html"
			})
		},
		message: function() {
			var n = h(this).attr("data-url");
			m.popupRight({
				id: "layer-notice",
				type: 2,
				content: n ? n : "/static/tpl/tpl-message.html"
			})
		},
		psw: function() {
			var n = h(this).attr("data-url");
			m.open({
				...
				title: "修改密码",
				shade: 0,
				content: n ? n : "/static/tpl/tpl-password.html"
			})
		},
		logout: function() {
			var n = h(this).attr("data-url");
