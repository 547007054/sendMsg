...
public class HttpUtils {
    ...
    public static String getQueryStr(Object bean) throws Exception {
        ...
        map = Maps.filterEntries(map, input -> {
            // 返回false表示排除该项
    ...
    private static SSLConnectionSocketFactory getSSLFactory() throws Exception {
        ...
        SSLContextBuilder sslBuilder = new SSLContextBuilder().loadTrustMaterial(null, (chain, authType) -> true);
